defmodule FuzzychatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FuzzychatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FuzzychatWeb.Gettext, "errors", msg, opts)
    end
  end
